...
//        equalsLabel.layer.cornerRadius = equalsLabel.frame.size.width / 2
//        equalsLabel.layer.shadowColor = UIColor.black.cgColor
//        equalsLabel.layer.shadowOpacity = 1.5
//        equalsLabel.layer.shadowOffset = CGSize(width: 2, height: 2)
//        equalsLabel.layer.borderWidth = 2
//        equalsLabel.layer.borderColor =  UIColor(named: "colorOneForGrad")?.cgColor
    }
